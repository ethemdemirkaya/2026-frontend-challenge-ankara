...
export const OverviewBoard = ({ totalEvents, allEvents }: OverviewProps) => {
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      
      {/* Vaka Özeti */}
      <div className="card bg-base-100 shadow-xl border-l-4 border-error rounded-none">
        <div className="card-body">
          ...
          <p className="text-base-content/80 leading-relaxed text-justify">
            ...
            <br/><br/>
            <strong>Görev Talimatı:</strong> Sol taraftaki istihbarat havuzundan bir şahıs seçerek soruşturmayı derinleştirin.
          </p>
        </div>
      </div>

      {/* Tüm Ankara Haritası (Genel Görünüm) */}
      <div className="card bg-base-100 shadow-xl rounded-none border border-base-content/10">
        <div className="card-body p-6">
          <h3 className="font-bold mb-4 uppercase tracking-widest border-l-4 border-primary pl-4">Genel Saha Hareketliliği</h3>
          <p className="text-xs opacity-60 mb-4">Aşağıdaki harita, veritabanımızdaki tüm şahısların Ankara içerisindeki son bilinen konumlarını göstermektedir. Kırmızı pinler Podo'nun görüldüğü noktalardır.</p>
